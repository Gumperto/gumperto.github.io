...
Principles range from very basic to probably higher level as I go further down the line. Principles may get added, deleted, or slightly tweaked as I think more about the website.

1. Sections are for content **formats** (i.e whether it's fiction or not), while tags are for specific **content markers** (i.e is it computer science, art, etc) 
