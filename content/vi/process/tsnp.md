...
together a bunch of shell scripts with duct tape and symlinks.

As far I understood software, it wasn't as if the general principle was any different 
(i.e. pay attention to your data structures!), but this seemed like a different, 
more involving workflow. For a dirty shell slinging power user, this makes for novel 
